          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="statut" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('statut')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="role_utilisateur" value="<?php echo $this->input->post('role_utilisateur'); ?>" class="form-control" id="role_utilisateur" />
						</div>
					</div>
					<div class="col-md-6">
